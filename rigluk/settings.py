...
SITE_BASE = (getenv("SITE_BASE", "https://rigluk.com") or "https://rigluk.com").rstrip("/")
...
STRIPE_PRICE_ID_PERSONAL_JPY = getenv("STRIPE_PRICE_ID_PERSONAL_JPY")
STRIPE_PRICE_ID_STUDIO_JPY = getenv("STRIPE_PRICE_ID_STUDIO_JPY")
...
SMTP_FROM = getenv("SMTP_FROM", "rigluk gang <support@rigluk.com>")
