...
SURVEY_PAGE_URL = "https://rigluk/research/2026-vintage-synth-owner-survey"
SURVEY_DATA_URL = f"{SURVEY_PAGE_URL}/data.json"

SURVEY_2026 = {    "title": "2026 Vintage Synth Owner Survey",
    "period": "June 25 – July 1, 2026",
    "method": "In-product survey (PostHog) shown to rigluk visitors. Question 1 required; Question 2 optional free text.",
    "shown": 2417,
    "responses_q1": 61,
    "responses_q2": 24,
    ...
    "caveats": [
        ...
        "Survey shown only to rigluk visitors (2.57% conversion) — biased toward people already curious about SysEx tools.",
    ],
}
...
def public_json() -> dict:
    return {
        ...
        "description": (
            ...
            "from rigluk, June 25 to July 1, 2026."
        ),
        "url": SURVEY_PAGE_URL,
        "creator": {
            "@type": "Organization",
        ...
        "citation": (
            f"Half Radiation LLC, {SURVEY_2026['title']}, rigluk, {SURVEY_2026['period']}."
        ),
        "data": SURVEY_2026,
    }
