...
def ping_indexnow(local=False):
    sitemap_url = "http://127.0.0.1:8000/sitemap.xml" if local else "https://bipluk.com/sitemap.xml"
    ...
    for url_tag in root.findall('.//ns:loc', ns):
        ...
        if local:
            ...
            url = url.replace("https://bipluk.com", "http://127.0.0.1:8000")
        urls.append(url)
    ...
    payload = {
        "host": "bipluk.com" if not local else "127.0.0.1:8000",
        "key": "7f8b9e6c5d4c3b2a1a0f9e8d7c6b5a4f",
        "keyLocation": "https://bipluk.com/7f8b9e6c5d4c3b2a1a0f9e8d7c6b5a4f.txt" if not local else "http://127.0.0.1:8000/7f8b9e6c5d4c3b2a1a0f9e8d7c6b5a4f.txt",
        "urlList": urls
    }
