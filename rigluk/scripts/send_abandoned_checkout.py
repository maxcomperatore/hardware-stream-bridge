...
def http_json(method: str, url: str, body: dict | None = None) -> dict:
    headers = {"Authorization": f"Bearer {CRON_SECRET}", "User-Agent": "rigluk-abandoned-checkout/1.0"}
    data = None
    if body is not None:
...
def send_resend(to: str, subject: str, body: str, html: str, from_addr: str, reply_to: str) -> tuple[bool, str | None]:
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "rigluk-abandoned-checkout/1.0",
...
def main() -> int:
    ...
    from_addr = queue.get("from", "rigluk gang <support@rigluk.com>")
