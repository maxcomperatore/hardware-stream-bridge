...
LESSONS_PAGE_URL = "https://rigluk/research/2026-browser-sysex-vault-launch-lessons"
...
LESSONS_LAUNCH_2026 = {
    ...
    "method": (
        "Operational data from Half Radiation LLC running rigluk. Metrics include PostHog survey logs, "
    ...
    "hacker_news": {
        ...
        "related_post": "https://rigluk/how-do-you-keep-web-midi-from-crashing-a-1983-synthesizer",
        "points": 52,
        "comments": 41,
    ...
    "caveats": [
        ...
        "rigluk visitors are biased toward people already searching for SysEx backup tools.",
    ],
}
...
def public_json() -> dict:
    return {
        ...
        "description": (
            "First-party launch lessons from running rigluk, a browser SysEx vault, "
        ...
        "citation": (
            f"Half Radiation LLC, {LESSONS_LAUNCH_2026['title']}, rigluk, "
