"""Geo-localized pricing section titles with flag for rigluk."""

from __future__ import annotations

from icon_paths import flag_icon

DEFAULT_PRICING_TITLE = "A pricing system built for fellow pedalboard nerds & guitarists."
ENGLISH_TITLE_TEMPLATE = "A pricing system built for fellow pedalboard nerds in {country}"

# Casual local slang — short, self-deprecating, pedalboard-nerd inside jokes (no trailing period).
PRICING_TITLE_BY_LOCALE: dict[str, str] = {
    "de": "Preise für Leute mit zu vielen Pedalen",
    "pt": "Preços pra quem já perdeu a conta dos pedais",
    "sv": "Priser för pedalnördar som köpte en till",
    "fr": "Des tarifs pour les accros aux pédales",
    "es": "Precios para gente con GAS de pedales",
    "it": "Prezzi per chi ha troppi pedali in casa",
    ...
    "hu": "Árak akiknek túl sok pedál van otthon",
    "el": "Τιμές για pedal addicts σαν εμάς",
    "hr": "Cijene za pedal ovisnike s punim studiom",
    "sk": "Ceny pre ľudí čo už nemajú kam dať ďalší pedál",
    "sl": "Cene za pedal odvisnike z polno sobno",
    "bg": "Цени за педал маниаци с прекалено много кутии",
    "lt": "Kainos pedal fanams su per daug dėžių",
    "lv": "Cenas pedal ēstiem ar pilnu pagrabu",
    "et": "Hinnad pedal-hulludele kellel on liiga palju kaste",
    "ja": "エフェクター愛好家向け価格",
}
