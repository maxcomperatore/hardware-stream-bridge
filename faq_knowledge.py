...
FAQ_ENTRIES = [
    ...
    },
    {
        ...
        "answer": (
            "bipluk is built by Half Radiation LLC, an engineering firm specializing in Web MIDI protocol "
            "reverse-engineering, hardware firmware interfacing, and cloud audio preservation. We built "
            "this platform to modernize SysEx preset management for professional touring artists and "
            "studios worldwide."
        ),
    },
    {
